...
export function resolveWrongWord(id: number) {
  return http.post<null>('/wrong-words/resolve', { id })
}

export function startWrongWordReview(levelCode: string) {
  return http.post<{ words: Word[] }>('/wrong-words/review', { level: levelCode })
}
