...
从零创建 `wordmate-mini/` 目录，目标是一套代码同时编译微信小程序 + Android APK + H5。  
参考文档：`prompts/uniapp.md`、`docs/08-wordmate-mini.md`、`docs/03-api-specification.md`。
...
```
wordmate-mini/.env.development   → VITE_API_BASE=http://localhost:8080/api/v1
wordmate-mini/.env.production    → VITE_API_BASE=https://api.vocabmaster.com/api/v1
```
